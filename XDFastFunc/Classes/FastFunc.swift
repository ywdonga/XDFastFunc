...
extension UITableView {
    ...
    public func registerNibCell<T: UITableViewCell>(_ cellClass: T.Type) {
    ...
    /// 注册代码cell
    /// - Parameter cellClass: cell类
    public func registerClassCell<T: UITableViewCell>(_ cellClass: T.Type) {
        let idf = String(describing: cellClass)
    ...
    /// - Returns: 对应类型的cell
    public func dequeueReusableCell<T: UITableViewCell>(_ indexPath: IndexPath? = nil) -> T! {
    ...
    public func registerNibHeaderFooter<T: UIView>(_ hfClass: T.Type) {
    ...
    /// 注册代码HeaderFooter
    /// - Parameter hfClass: HeaderFooter类
    public func ts_registerClassHeaderFooter<T: UIView>(_ hfClass: T.Type) {
        let idf = String(describing: hfClass)
    ...
    public func dequeueReusableHeaderFooter<T: UIView>(_ hfClass: T.Type) -> T! {
        let idf = String(describing: hfClass)
...
extension UICollectionView {
    ...
    /// 注册xib Cell
    /// - Parameter cellClass: cell类
    public func registerNibCell<T: UICollectionViewCell>(_ cellClass: T.Type) {
        let idf = String(describing: cellClass)
        let nib = UINib(nibName: idf, bundle: nil)
    ...
    /// 注册代码cell
    /// - Parameter cellClass: cell类
    public func registerClassCell<T: UICollectionViewCell>(_ cellClass: T.Type) {
        let idf = String(describing: cellClass)
    ...
    /// - Parameter indexPath: cell位置
    /// - Returns: 对应类型的cell
    public func tdequeueReusableCell<T: UICollectionViewCell>(_ cellClass: T.Type, indexPath: IndexPath) -> T! {
        let idf = String(describing: cellClass)
